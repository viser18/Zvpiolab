...
public class User implements UserDetails {
    ...
    public User(Long id, String name, String email, String password, ApplicationUserRole role) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public static class UserBuilder {
        ...
        public UserBuilder role(ApplicationUserRole role) { this.role = role; return this; }
